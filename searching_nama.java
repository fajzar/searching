...
public class searching_nama {
    public static void main(String[] args) {
        ...
        String nama_arr[] = { "Andri Hariadi", "Dewi Lestari", "Dewi Agustin", 
            "Reni Indrayati", "Toni Sukmawan", "Toni Gunawan" };
        String alamat[] = { "Bandung", "Surabaya", "Malang", 
            "Malang", "Surabaya", "Bandung" };

        int n = nama_arr.length;
        ArrayList<Integer> posisi;
        posisi = cariLinear(nama_arr, n, "Toni");
